...
$.extend( $.validator, {
	...
	messages: {
		...
		min: $.validator.format( message_alert("Please enter a value greater than or equal to {0}." ))
	},
...
function message_info(e) {
	return "<div class='input-group alert alert-info'><span class='glyphicon glyphicon-exclamation-sign' aria-hidden='true'></span> "+e+"</div>";
}
*/