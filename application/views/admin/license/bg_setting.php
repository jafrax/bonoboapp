                                ...
                                <div class='col-xs-12 col-md-6'> 
                                    <div class='row form-group'>
                                        ...
                                        <div class='padbottom col-xs-12 col-md-3'>
                                            <input type='text' class='form-control' name='code_1' maxlength='4' placeholder='xxxx' value='".($arr_code[0] != '' ? $arr_code[0] : "")."'/>
                                        </div>
                                        <div class='padbottom col-xs-12 col-md-3'>
                                            <input type='text' class='form-control' name='code_2' maxlength='4' placeholder='xxxx' value='".($arr_code[1] != '' ? $arr_code[1] : "")."'/>
                                        </div>
                                        <div class='padbottom col-xs-12 col-md-3'>
                                            <input type='text' class='form-control' name='code_3' maxlength='4' placeholder='xxxx' value='".($arr_code[2] != '' ? $arr_code[2] : "")."'/>
                                        </div>
                                        <div class='padbottom col-xs-12 col-md-3'>
                                            <input type='text' class='form-control' name='code_4' maxlength='4' placeholder='xxxx' value='".($arr_code[3] != '' ? $arr_code[3] : "")."'/>
                                        </div>
                                    </div>
                                    <div class='row form-group'>
                                        ...
                                        <div class='padbottom col-xs-12 col-md-3'>
                                            <input type='text' class='form-control numbersOnly' maxlength='2' id='duration' placeholder='15' name='".$this->config->item('default_duration')."' value='".($duration != "" ? $duration  : "")."'>
                                        </div>
                                        <div class='padbottom col-xs-12 col-md-3'>
                                            <select class='form-control' id='duration_type' name='".$this->config->item('default_duration_type')."'>
