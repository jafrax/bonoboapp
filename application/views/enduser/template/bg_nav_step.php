...
echo "
	<div class='col s12 m12 l12'>
		<ul class='menucontent row'>
			<li class='col s12 m4 l3 langkah ".($this->uri->segment(2) == "" ? "active" : "")."'>
			...
			<li class='col s12 m4 l3 langkah ".($this->uri->segment(2) == "step2" ? "active" : "")."'>
			...
			<li class='col s12 m4 l3 langkah ".($this->uri->segment(2) == "step3" ? "active" : "")."'>
			...
			<li class='col s12 m4 l3 langkah ".($this->uri->segment(2) == "step4" ? "active" : "")."'>
			...
			<li class='col s12 m4 l3 langkah ".($this->uri->segment(2) == "step5" ? "active" : "")."'>
			...
			<li class='col s12 m4 l3 langkah ".($this->uri->segment(2) == "step6" ? "active" : "")."'>
			...
			<li class='col s12 m4 l3 langkah ".($this->uri->segment(2) == "step7" ? "active" : "")."'>
