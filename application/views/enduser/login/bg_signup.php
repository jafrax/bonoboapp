	...
	<content>
		<div class='containermain'>
			<div class='row col-signup'>
				<h4 class='titlin light'>BONOBO IS A SECURE BUSINESS PLATFORM</h4>
				...
				<form id='formSignup' class='signin z-depth-2'>
					<div class='row'>
						...
						<div class='input-field col s12'>
							<input id='name' name='name' type='text' class='validate' maxlength='50' autofocus placeholder='ex : Nama Toko' tabindex='1'>
							<label for='name'>Nama Toko</label>
							<label id='notifName' class='error' style='display:none;'><i class='fa fa-warning'></i> Harus diisi !</label>
						</div>
						<div class='input-field col s12'>
							<input id='email' name='email' type='text' class='validate emailLow' maxlength='50' tabindex='2'>
							<label for='email'>Email</label>
							<label id='notifEmail' class='error' style='display:none;'><i class='fa fa-warning'></i> Harus diisi !</label>
						</div>
						<div class='input-field col s12'>
							<input id='password' name='password' type='password' class='validate' maxlength='30' tabindex='3'>
