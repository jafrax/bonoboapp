					...
					<form class='formain'>
						...
						<div class='row formbody'>
							<p>
								...
								<h3 id='informasi' class='light title-faq '>Informasi Pengguna</h3>
								<p class='light'>Bonobo mengumpulkan informasi Pengguna dengan tujuan untuk memperoses dan memperlancar proses penggunaan situs Bonobo. Tindakan tersebut telah memperoleh persetujuan Pengguna pada saat pengumpulan informasi.</p><br>
								<p class='light'>Bonobo mengumpulkan informasi pribadi sewaktu Pengguna mendaftar ke Bonobo, sewaktu Pengguna menggunakan layanan Bonobo, sewaktu Pengguna mengunjungi halaman Bonobo atau halaman-halaman para mitra tertentu dari Bonobo, dan sewaktu Anda menghubungi Bonobo. Bonobo dapat menggabung informasi mengenai Pengguna yang kami miliki dengan informasi yang kami dapatkan dari para mitra usaha atau perusahaan-perusahaan lain.</p><br>
								<p class='light'>Sewaktu Anda mendaftar untuk menjadi Pengguna Bonobo, maka Bonobo akan mengumpulkan data pribadi Pengguna, yakni nama lengkap, alamat e-mail, nomor telepon yang dapat dihubungi, password dan informasi lainnya yang diperlukan. Dengan memberikan informasi / data tersebut, Anda memahami, bahwa Bonobo dapat meminta dan mendapatkan setiap informasi / data pribadi Pengguna untuk kesinambungan dan keamanan situs ini.</p><br>
								<p class='light'>Bonobo akan mengumpulkan dan mengolah keterangan lengkap mengenai transaksi atau penawaran atau hubungan financial lainnya yang Pengguna laksanakan melalui situs Bonobo dan mengenai pemenuhan pesanan Pengguna.</p><br>
								<p class='light'>Bonobo akan mengumpulkan dan mengolah data mengenai kunjungan Pengguna ke situs Bonobo, termasuk namun tidak terbatas pada data lalu-lintas, data lokasi, weblog, tautan ataupun data komunikasi lainnya, apakah hal tersebut disyaratkan untuk tujuan penagihan atau lainnya, serta sumberdaya yang Pengguna akses.</p><br>
								<p class='light'>Pada saat Pengguna menghubungi Bonobo, maka Bonobo menyimpan catatan mengenai korespondensi tersebut dan isi dari komunikasi antara Pengguna dan Bonobo.</p><br>
								<p class='light'>Pengguna memahami dan menyetujui bahwa nama Pengguna dan daerah Kota (bukan alamat lengkap) Pengguna merupakan informasi umum yang tertera di halaman profile Bonobo Pengguna.</p><br>
								<p class='light'>Bonobo dengan sendirinya menerima dan mencatat informasi dari komputer dan browser Pengguna, termasuk alamat IP, informasi cookie Bonobo, atribut piranti lunak dan piranti keras, serta halaman yang Pengguna minta.</p><br>
								<p class='light'>Setiap informasi / data Pengguna yang disampaikan kepada Bonobo dan/atau yang dikumpulkan oleh Bonobo dilindungi dengan upaya sebaik mungkin oleh perangkat keamanan teruji, yang digunakan oleh Bonobo secara elektronik. Meskipun demikian, Bonobo tidak menjamin kerahasiaan informasi yang Pengguna sampaikan tersebut, dalam kondisi adanya pihak-pihak lain yang mengambil atau mempergunakan informasi Pengguna dengan melawan hukum serta tanpa izin Bonobo.</p><br>
								<p class='light'>Kerahasiaan kata sandi atau password merupakan tanggung jawab masing-masing Pengguna. Bonobo tidak bertanggung jawab atas kerugian yang dapat ditimbulkan akibat kelalaian pengguna dalam menjaga kerahasiaan passwordnya.</p><br>
						<a href='#top'>kembali ke atas</a><br>
								________________________________________
								<h3 id='penggunaan' class='light title-faq '>Penggunaan Informasi</h3>
								<p class='light'>Bonobo dapat menggunakan keseluruhan informasi / data Pengguna sebagai acuan untuk upaya peningkatan produk dan pelayanan.</p><br>
								<p class='light'>Bonobo dapat mempergunakan dan mengolah Informasi / data Pengguna dengan tujuan untuk menyesuaikan situs Bonobo sesuai dengan minat Pengguna.</p><br>
								<p class='light'>Bonobo dapat menggunakan keseluruhan informasi / data Pengguna untuk kebutuhan internal Bonobo tentang riset pasar, promosi tentang produk baru, penawaran khusus, maupun informasi lain, dimana Bonobo dapat menghubungi Pengguna melalui email, surat, telepon, fax.</p><br>
								<p class='light'>Bonobo dapat meminta Pengguna melengkapi survei yang Bonobo gunakan untuk tujuan penelitian atau lainnya, meskipun Pengguna tidak harus menanggapinya.</p><br>
								<p class='light'>Bonobo dapat menghubungi Pengguna melalui email, surat, telepon, fax, termasuk namun tidak terbatas, untuk membantu dan/atau menyelesaikan proses transaksi jual beli antar Pengguna.</p><br>
								<p class='light'>Situs Bonobo memilki kemungkinan terhubung dengan situs-situs lain diluar situs Bonobo, dengan demikian Pengguna menyadari dan memahami bahwa Bonobo tidak turut bertanggung jawab terhadap kerahasiaan informasi Pengguna setelah Pengguna mengakses situs-situs tersebut dengan meninggalkan atau berada diluar situs Bonobo.</p><br>
						<a href='#top'>kembali ke atas</a><br>
								________________________________________
								<h3 id='pengguna' class='light title-faq '>Pengungkapan informasi Pengguna</h3>
								<p class='light'>Bonobo menjamin tidak ada penjualan, pengalihan, distribusi atau meminjamkan informasi / data pribadi Anda kepada pihak ketiga lain, tanpa terdapat izin dari Anda. Kecuali dalam hal-hal sebagai berikut:</p><br>
								<p class='light'>
								<ul>
