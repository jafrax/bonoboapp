...
if($Shop->flag_information == 0){
	$Button = "<a href='".base_url("toko/step5")."' class='btn waves-effect waves-light red'><i class='mdi-navigation-chevron-left left'></i> Kembali</a><button type='submit' class='btn waves-effect waves-light'>Lanjut<i class='mdi-navigation-chevron-right right'></i></button>";
}else{
