                ...
                <div class='input-field col s12 m1 nolmar'>
                    <div class='col s12 m12 left-align'>
                        <p class='left nolpad'>
                            ...
                            <input type='checkbox' class='filled-in' id='chkLevel2' ".($Shop->level_2_active == 1 ? "checked" : "")."  ".($status2 == 1 ? "disabled" : "")." onclik='javascript:on_change()' />
                ...
                <div class='input-field col s12 m1 nolmar'>
                    <div class='col s12 m12 left-align'>
                        <p class='left nolpad'>
                            ...
                            <input type='checkbox' class='filled-in' id='chkLevel3' ".($Shop->level_3_active == 1 ? "checked" : "")."  ".($status3 == 1 ? "disabled" : "")." onclik='javascript:on_change()' />                
                ...
                <div class='input-field col s12 m1 nolmar'>
                    <div class='col s12 m12 left-align '>
                        <p class='left nolpad'>
                            ...
                            <input type='checkbox' class='filled-in' id='chkLevel4' ".($Shop->level_4_active == 1 ? "checked" : "")."  ".($status4 == 1 ? "disabled" : "")." onclik='javascript:on_change()' />
                ...
                <div class='input-field col s12 m1'>
                    <div class='col s12 m12 left-align'>
                        <p class='left nolpad'>
                            ...
                            <input type='checkbox' class='filled-in' id='chkLevel5' ".($Shop->level_5_active == 1 ? "checked" : "")."  ".($status5 == 1 ? "disabled" : "")." onclik='javascript:on_change()' />
